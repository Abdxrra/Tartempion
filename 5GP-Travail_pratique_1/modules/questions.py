...
class Questions:
    ...
    def __init__(self, chemin_fichier_bd="questions.bd") -> None:
        self.integrite = "e237901780d71b2b0cf938819afb2e1a398339f45686b218b11fb31e062e550d"
    ...
    def choisir_questions(self, nombre_de_questions: int) -> list:
        ...
        return [[question, Indicateur.VIDE] for question in random.choices(self.banque_questions, k=nombre_de_questions)]

    def verifier_integrite(self) -> bool:
        """Verifie l'integrité du fichier bd"""

        return self.integrite == hash_fichier(self.chemin_fichier_bd)
