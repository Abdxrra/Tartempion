...
class Partie:
    ...
    def __init__(self, difficulte_choisie: Difficulte, musique_choisie: Musique):
        ...
        self.musique_choisie = musique_choisie
    ...
    def afficher(self, question: tuple) -> None:
    ...
    def effacer_question(self) -> None:
    ...
    def fin_partie(self, est_un_echec: bool) -> None:
